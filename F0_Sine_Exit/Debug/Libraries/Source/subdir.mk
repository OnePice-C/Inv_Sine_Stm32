...
Libraries/Source/%.o Libraries/Source/%.su: ../Libraries/Source/%.c Libraries/Source/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m0 -std=gnu11 -g3 -DDEBUG -DSTM32 -DSTM32F0 -DSTM32F030K6Tx -DSTM32F030 -DUSE_STDPERIPH_DRIVER -c -I"F:/STM32_Sine_CubeIDE/F0_Sine_Exit/Libraries/Code_CM0" -I"F:/STM32_Sine_CubeIDE/F0_Sine_Exit/Inc" -I"F:/STM32_Sine_CubeIDE/F0_Sine_Exit/Libraries/Include" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
